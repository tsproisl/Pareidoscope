...
cwb-encode -d $data -f $corpus -R "$registry/$regfile" -xsB -P pos -P lemma -P wc -P indep -P outdep -P root -S s:0+id+id_md5_base64+original_sentence_id+len -S adjp:0 -S advp:0 -S conjp:0 -S intj:0 -S lst:0 -S np:0 -S o:0 -S pp:0 -S prt:0 -S qp:0 -S sbar:0 -S ucp:0 -S vp:0 -S h:0 -S text:0+id+original_id -0 corpus
