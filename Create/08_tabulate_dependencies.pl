...
sub fill_database {
    ...
    $cqp->exec("tabulate A match .. matchend indep, match .. matchend outdep, match .. matchend root, match .. matchend, match s_id, match s_ignore, match .. matchend word > \"$outdir/dependencies.out\"");
